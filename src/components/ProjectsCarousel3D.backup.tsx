...
function World({ scrollOffsetRef, wheelDeltaRef, bendRef, visible, onHover }: WorldProps) {
...
export function ProjectsCarousel3D({
  ...
  return (
    <div
      ...
      onClick={() => play("click")}
      style={{
        // Stay fully visible while the per-card reveal/hide animation plays
        // (cards fade themselves via uRevealProgress). Only suppress
        // pointer-events when hidden so the list view can be interacted with.
